(() => {
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            const picker = datepicker_min("[data-datepicker]", {
                ...
                formatter: (input, date, instance) => {
                    const checkOutDate = date.toDateString();
                    let value = checkOutDate.split(" ");
                    const day = value[0] + ",";
                    let numb;
                    if ("01" === value[2]) numb = value[2] + "st"; else if ("02" === value[2]) numb = value[2] + "nd"; else if ("03" === value[2]) numb = value[2] + "rd"; else numb = value[2] + "th";
                    value[0] = day;
                    value[2] = value[1];
                    value[1] = numb;
        ...
        if (document.querySelector("[data-datepicker2]")) {
            const picker2 = datepicker_min("[data-datepicker2]", {
                customDays: [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ],
                customMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ],
                overlayButton: "Apply",
                overlayPlaceholder: "Year (4 numbers)",
        ...
        function initSliders() {
            if (document.querySelector(".slider-main__slider")) new core(".slider-main__slider", {
                ...
                navigation: {
                    prevEl: ".arrow-destination__left",
                    nextEl: ".arrow-destination__right"
                },
                on: {}
            });
            //!!!! ================ OFFER SLIDER ========================
                        if (document.querySelector(".slider-offer__slider")) new core(".slider-offer__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrow-offer__left",
                    nextEl: ".arrow-offer__right"
                },
                effect: "fade",
                autoplay: {
                    delay: 3e3,
            ...
            //!!!! ================ trip planner SLIDER ========================
                        if (document.querySelector(".slider-trip__slider")) new core(".slider-trip__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                breakpoints: {
            ...
            //!!!! ================ GALLERY SLIDER ========================
                        if (document.querySelector(".slider-gallery__slider")) new core(".slider-gallery__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                breakpoints: {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrow-gallery__left",
                    nextEl: ".arrow-gallery__right"
                },
                effect: "fade",
                autoplay: {
                    delay: 3e3,
            ...
            //!!!! ================ REVIEWS SLIDER ========================
                        if (document.querySelector(".slider-review__slider")) new core(".slider-review__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                breakpoints: {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".arrow-review__left",
                    nextEl: ".arrow-review__right"
                },
                effect: "fade",
                autoplay: {
                    delay: 3e3,
